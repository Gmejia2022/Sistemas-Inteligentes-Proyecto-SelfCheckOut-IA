...
## Clasificar imágenes con DataSet de Frutas, Guarda el modelo en la ruta especificada
...
BATCH_SIZE = 36  # Define el número de muestras que se propagarán a través de la red antes de actualizar los pesos.
...
ruta_imagen = r'C:\ML\FrutasDataSet\Datos\fruits-360_dataset\fruits-360\test-multiple_fruits\Bananas(lady_finger)1.jpg'  # La 'r' al principio indica una cadena de texto cruda para manejar las barras invertidas en la ruta
